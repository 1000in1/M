...
// `
// recv: uagv/v2/test/test-04/instantActions {
//   "headerId" : 861,
//   "timestamp" : "2024-11-29T10:00:23.314731Z",
//   "version" : "2.0.0",
//   "manufacturer" : "test",
//   "serialNumber" : "test-04",
//   "actions" : [ {
...
// recv: uagv/v2/test/10SIMdev000C-05/instantActions {
//   "headerId" : 905,
...
func vda5050_load_data(t *testing.T) *VDA5050 {
	...
	vda5050s := NewVDA5050("robot_test_111", "test", "v0.0.1")

	var json_str = `{  "headerId" : 365,  "timestamp" : "2024-11-29T07:49:11.964946Z",  "version" : "2.0.0",  "manufacturer" : "test",  "serialNumber" : "10SIMdev000C-05",  "actions" : [ {    "actionType" : "stopPause",    "actionId" : "1b8d94df-963d-4691-9174-434bd0ec1562",    "blockingType" : "NONE"  } ]}`

	json_str = `{  "headerId" : 366,  "timestamp" : "2024-11-29T07:49:13.580231Z",  "version" : "2.0.0",  "manufacturer" : "test",  "serialNumber" : "10SIMdev000C-05",  "actions" : [ {    "actionType" : "startPause",    "actionId" : "c75cf5c5-953e-43e5-aa53-86f8959853d4",    "blockingType" : "NONE"  } ]}`

	_ = testInstantActions(t, vda5050s, json_str)

	json_str = `{  "headerId" : 905,  "timestamp" : "2024-11-29T10:00:34.172682Z",  "version" : "2.0.0",  "manufacturer" : "test",  "serialNumber" : "10SIMdev000C-05",  "actions" : [ {    "actionType" : "updateLastNodeId",    "actionId" : "2c879c22-66b6-4ff7-aff1-0e774aee4e89",    "blockingType" : "NONE",    "actionParameters" : [ {      "key" : "nodeId",      "value" : "6731b182088f262df9845fe2"    }, {      "key" : "isManual",      "value" : false    } ]  } ]}`
	_ = testInstantActions(t, vda5050s, json_str)

	json_str = `{  "headerId" : 865,  "timestamp" : "2024-11-29T10:00:29.385138Z",  "version" : "2.0.0",  "manufacturer" : "test",  "serialNumber" : "test-04",  "actions" : [ {    "actionType" : "startJacking",    "actionId" : "a118c742-9532-44fc-ab7e-338cfb1e781e",    "blockingType" : "HARD",    "actionDescription" : "drop the shelves",    "actionParameters" : [ {      "key" : "type",      "value" : 1    } ]  } ]}`
...
func Test_vda5050_GetConnectionJsonString(t *testing.T) {

	vda5050s := vda5050_load_data(t)
	s, err := vda5050s.GetConnectionJsonString(connection.Online)
	if err != nil {
		t.Error(err)
	}
	fmt.Println(string(s))
...
func Test_vda5050_changeState(t *testing.T) {

	vda5050s := vda5050_load_data(t)
	vda5050s.SetLogger(logger.NewLogger())

	battery := vda5050s.GetBatteryState()

	battery.Charging = false
	battery.BatteryHealth = 1
	battery.BatteryCharge = 0.5
	battery.BatteryVoltage = 12.3
	battery.Reach = 9999999

	agv := vda5050s.GetAgvPosition()
...
func Test_heading(t *testing.T) {
	g2d.CalculateHeading(g2d.Point{X: 0, Y: 0}, g2d.Point{X: 1, Y: 1})
}

func Benchmark_Test_vda5050_InstantActions(b *testing.B) {
	t := &testing.T{}
